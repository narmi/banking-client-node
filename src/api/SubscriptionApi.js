...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/InlineResponse2008', 'model/InlineResponse2011', 'model/Subscription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/InlineResponse2008'), require('../model/InlineResponse2011'), require('../model/Subscription'));
  } else {
    // Browser globals (root is window)
    if (!root.BankingClient) {
      root.BankingClient = {};
    }
    root.BankingClient.SubscriptionApi = factory(root.BankingClient.ApiClient, root.BankingClient.Error, root.BankingClient.InlineResponse2008, root.BankingClient.InlineResponse2011, root.BankingClient.Subscription);
  }
}(this, function(ApiClient, Error, InlineResponse2008, InlineResponse2011, Subscription) {
  'use strict';
